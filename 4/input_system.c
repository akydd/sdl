...
void input_system_update(SDL_Event e, world *world) {
	if(e.type == SDL_KEYDOWN) {
		...
		{
			case SDLK_UP:
			world_add_graphic_component(world, new_entity, "../images/up_arrow.bmp");
			world_add_size_component(world, new_entity, 100, 100);
			world_add_position_component(world, new_entity, 270, 0);
			break;

			case SDLK_DOWN:
			world_add_graphic_component(world, new_entity, "../images/down_arrow.bmp");
			world_add_size_component(world, new_entity, 100, 100);
			world_add_position_component(world, new_entity, 270, 380);
			break;

			case SDLK_LEFT:
			world_add_graphic_component(world, new_entity, "../images/left_arrow.bmp");
			world_add_size_component(world, new_entity, 100, 100);
			world_add_position_component(world, new_entity, 0, 190);
			break;

			case SDLK_RIGHT:
			world_add_graphic_component(world, new_entity, "../images/right_arrow.bmp");
			world_add_size_component(world, new_entity, 100, 100);
			world_add_position_component(world, new_entity, 540, 190);
			break;

			default:
			world_add_graphic_component(world, new_entity, "../images/any_key.bmp");
			world_add_size_component(world, new_entity, 100, 100);
